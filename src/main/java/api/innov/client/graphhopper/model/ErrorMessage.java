...
public class ErrorMessage {
   ...
   * @return message
  **/
  @Schema(example = "unsupported json property [vehiles]. allowed properties: [vehicles, vehicle_types, services, shipments, relations, algorithm, objectives, cost_matrices, configuration]", description = "error message")
   ...
   * @return details
  **/
  @Schema(example = "class java.lang.IllegalArgumentException", description = "Details")
