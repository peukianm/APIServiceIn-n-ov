...
import api.innov.client.graphhopper.model.IsochroneResponsePolygon;
...
public class IsochroneResponse {
   ...
   * @return polygons
  **/
  @Schema(description = "The list of polygons in GeoJson format. It can be used e.g. in the Leaflet framework:  ``` L.geoJson(json.polygons).addTo(map) ```  The number of polygon is identical to the specified buckets in the query. Every polygon contains the bucket number in the properties section of the GeoJson. ")
