...
import api.innov.client.graphhopper.model.SnappedWaypoint;
...
public class ResponseAddress {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.locationId, responseAddress.locationId) &&
        Objects.equals(this.name, responseAddress.name) &&
        Objects.equals(this.lon, responseAddress.lon) &&
        Objects.equals(this.lat, responseAddress.lat) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(locationId, name, lon, lat, streetHint, snappedWaypoint);
  }
