 ...
 */
@Schema(description = "Access point to the (road)network. It is only available if `return_snapped_waypoints` is true (be default it is false).")
...
public class SnappedWaypoint {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.lon, snappedWaypoint.lon) &&
        Objects.equals(this.lat, snappedWaypoint.lat);
  }
