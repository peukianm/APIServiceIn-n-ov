...
import api.innov.client.graphhopper.model.CostMatrixData;
...
public class CostMatrix {
   ...
   * @return type
  **/
  @Schema(description = "type of cost matrix, currently default or google are supported")
  ...
  **/
   ...
   * @return profile
  **/
  @Schema(description = "vehicle profile or empty if catch all fallback")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, locationIds, data, profile);
  }
