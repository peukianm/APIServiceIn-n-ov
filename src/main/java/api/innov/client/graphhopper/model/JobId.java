...
public class JobId {
   ...
   * @return jobId
  **/
  @Schema(example = "44886560-b584-4da5-b245-768151dacd8f", description = "UUID. Unique id for your job/request with which you can fetch your solution")
