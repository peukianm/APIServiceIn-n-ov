...
import api.innov.client.graphhopper.model.IsochroneResponsePolygonProperties;
import api.innov.client.graphhopper.model.Polygon;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * A found path
 */
@Schema(description = "A found path")
...
public class IsochroneResponsePolygon {
  ...
  **/
  ...
  public IsochroneResponsePolygon geometry(Polygon geometry) {
